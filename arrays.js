...
const lot_33 = (arr) => {
	...
	arr.forEach((e) => {
		if (e.id === 33) {
			carLot.push(e.car_year, e.car_make, e.car_model);
		}
	});
	carLot;
};
...
// console.log(`${car_33.car_year} ${car_33.car_make} ${car_33.car_model}`);

// console.log(inventory[33].car_year.carModels);
